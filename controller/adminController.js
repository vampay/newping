...
// const Admin = require("../models/auth"); // Ensure the path is correct
...
//         const admin = await Admin.findOne({ email }).select("-password role"); // Ensure `role` is included
// //ไม่ให้ส่งpassword กลับมา
